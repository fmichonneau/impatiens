...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: could not find function "{}extToLbl"{}}}\end{kframe}\begin{figure}[]


{\centering \includegraphics[width=\maxwidth]{../figure/latex-impatiens-tree} 
