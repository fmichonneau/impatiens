...
Despite the challenges associated with its definition, species constitute the
biological unit used to assess patterns of diversity, identify regions of
conservation concern and manage exploited resources \cite{Pimm2014}. For many
taxonomic groups, species limits are misunderstood and the fraction of
undescribed diversity debated making global estimates of diversity uncertain
\cite{Appeltans2012,Costelo2013}. DNA-based species delineation methods have
become increasingly popular as they provide an inexpensive and efficient way to
identify species complexes. These methods are efficient as genetic data carry
the signature of the historical processes experienced by the species. In
particular, the expected level of genetic divergence between reproductively
isolated populations is proportional to the amount of time since they shared a
common ancestor \cite{Hey2010-IMa2}. Reproductive isolation, the key factor in
species delineation can therefore be detected by analyzing patterns of molecular
evolution. The recent development of coalescent-based methods using multi-locus
datasets have allowed to overcome some of the shortcomings of single-locus
analyses where various processes can lead to the same patterns.

The use of molecular methods to investigate patterns of species diversity has
revealed many species complexes. In particular, species thought to be widespread
are often complexes of divergent lineages with restricted geographical ranges
(e.g., \cite{Brown2007,Meyer2005-evolution}, ...). These findings among marine
organisms have been challenging the classical view of how speciation operates in
the sea \cite{Mayr1954}. Since most marine invertebrates have a highly
dispersive larval stage, and that oceans in general and the Indo-Pacific in
particular lack clear geographical barriers to dispersal opportunities for
allopatric speciation seem limited. Yet, while many closely related species have
non-overlapping distributions suggesting that allopatric is the most common mode
of speciation, overlap among species distributions is common. Recent geological
and molecular evidence suggests that most of the modern reef fauna is recent
(Miocene) \cite{Renema2008}, leading to the realization that (1) selection
(along environemental gradients, sexual selection, host specificity) may play an
important role in reproductive isolation (reviewed in \cite{Bowen2013}); (2)
important changes in species ranges and distributions have obscurred the
barriers responsible for the initiation of reproductive isolation.
...
relatively recent as sea levels have fluctuated greatly (\textit{ca}. 100-150~m)
and repeatedly (\textit{ca}. 100,000~years periodicity) during the late Tertiary
and early Quarternary. These fluctuations have led to important habitat
modifications and changes in oceanic current patterns with consequences in
connectivity, population sizes and species ranges. These changes have made
species distributions in the Pacific highly dynamic (\cite{Paulay1990}) and are,
in most cases, too recent compared to the time frame needed for speciation.
...
reef-associated fauna has occurred. This is illustrated by the observation that
...
ranges and colonized one of the basin recently.
...
current landscape of the Indo-Pacific is relatively recent. For instance,
...
taxonomists have relied on these skeletal elements to differentiate species. For
instance, in sea cucumbers, species-level taxonomy has almost entirely relied on
the shape of ossicles, microscopic calcareous secretions found in many
tissues. At least until the late 1980's most species descriptions would ignore
intraindividual variation by figuring only ossicles found in the body wall of
the species, and generally ignored any intraspecific variation by illustrating
the ossicle assemblage of a single individual.

% who were the first authors to illustrate ossicles?

Forrsk\r{a}ll described \textit{Holothuria impatiens} in 1775 from the
collections he was making in Suez, Egypt. His description is imprecise, but
mentions that the the body wall is gray with dark spot and well-developed,
lightly colored tubercles are present. The drawing accompanying the description
corroborates these observations. Since then, the range of \textit{H. impatiens}
has been extended, and the species is now thought to be occurring in the Red
Sea, throughout the Indo-West Pacific, the Caribbean and the Mediterrean.

Pearson \cite{Pearson1915} designated \textit{Holothuria impatiens} as the type
species of \textit{Thymiosycia}, one of the 18 subgenera in
\textit{Holothuria}. The modern concept of \textit{Thymiosycia} was proposed by
Rowe \cite{Rowe1969} to include species which are characterized by having well
developed, regular and symmetrical tables and buttons. The ossicle assemblage of
\textit{H. impatiens} therefore exemplifies the ossicle assemblage of the family
Holothuriidae.

% \cite{Pearson1915} to include species of Holothuriidae being characterized by
% the absence of ``true pedicels'' and anal teeth, and the presence of
% ``papillae scattered all over the body, generally on eminences''
...
back-reef habitats) but has been recorded down to 158~m
(\cite{Samyn2014-Miriky}).  Because of its ubiquituous distribution, it is one
of the more studied species of holothuriid with studies on its reproduction
\cite{Harriott1985}, its Cuvierian tubules \cite{Flammang2002},
\cite{Becker+Flammang2010}; its toxicity \cite{Bakus1974}; its feeding
preferences \cite{Roberts1982}; the chemical composition \cite{Hampton1958},
statistical analysis \cite{Hampton1959}, ontogenic changes in its ossicles
\cite{Cutress1996}; and its parasites \cite{Martens1994}.  It has also been
included in molecular phylogenies to investigate relationships among the major
groups of holothurians (e.g., \cite{Lacey2005}) or as an outgroup when studying
relationships within a sub-genus (e.g.,
\cite{Honey-Escandon2012}). \textit{Holothuria impatiens} is a low-value
commercial species but has been reported to be fished in the Eastern Pacific
...
can be distinguished relatively easily from their live appearance, others can
only be identified genetically. This, in combination with the fact that several
of these species co-occur, and sometimes even share the same habitat, has
contributed to the failure to identify the species limits in this complex.
