...
\subsection{Species delineation with other lines of evidence: coloration and
  geography} 
...
barely raise from the body wall, giving them a smooth appearance. They are also
much larger than the other species and specimens reach regularly more than
30~cm. \texttt{gracilis} has very large conical, typically red tubercles and a
very distinctive ``gritty'' texture.  \texttt{ESU3} has elongated, pyramidal
tubercles with white papillae. However, \texttt{ESU1}, \texttt{Hawaii} and
\texttt{Wpac} have broadly overlapping distributions and are morphologically
indistinguishable (Figure~\ref{fig:photo-ESU1-andFriends}).
