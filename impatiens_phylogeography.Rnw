...
\begin{figure}
  \centering
    \includegraphics[width=6.5in]{manual-figures/species_limits.pdf}
...
\begin{figure}
  \centering
    \includegraphics[width=6.5in]{manual-figures/figure-group1.jpg}
...
\begin{figure}
  \centering
    \includegraphics[width=6.5in]{manual-figures/figure-group2.jpg}
    \caption{Dorsal view of members of the ``\textit{Holothuria impatiens}''
...
\begin{figure}
  \centering
    \includegraphics[width=6.5in]{manual-figures/figure-group3.jpg}
    \caption{Dorsal view of members of the ``\textit{Holothuria impatiens}''
