...
\cite{Meyer2005,Malay2010,Williams2011}). As a result, groups of closely related
species show strict allopatric distribution in oceanic setting (e.g., as in
...
taxa but are faster in continental settings than in oceanic settings. For
...
secondary sympatry takes a long time to occur.
