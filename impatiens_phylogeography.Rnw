...
differentiation in these loci for the putative species tested by the
models.
...
\cite{Leache2013,Drummond2014}. This would however require to analyze many more
loci than in the present study to obtain accurate estimates of population sizes
\cite{Heled2010}. Determining how the Bayes factors will behave if the null
hypotheses is misspecified remain to be investigated.
