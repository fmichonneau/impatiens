...
%% gmyc tree
\begin{figure}
  {\centering \includegraphics[width=\maxwidth]{figures-remake/gmyc-tree-all-sequences}}
...
\begin{figure}
  {\centering \includegraphics[width=\maxwidth]{figures-remake/gmyc-tree-unique-sequences}}
  \caption{Position of the species delineated with GMYC on COI genealogies
    estimated using various priors with BEAST. Each color corresponds to a
