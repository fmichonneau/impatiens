...
along the coastline of Oman have diverged 5 Ma ago \cite{Williams2011}. Here we
observe a different pattern with closely related species occurring in sympatry
even though they diverged recently (less than 1 Ma for ESU1 and Hawaii; and
about 1.5 Ma for ESU1 and Wpac). This pattern indicates that the species have
been able to evolve reproductive isolation in a short amount of time, and
contrasts with the pattern typically observed for oceanic settings, where
secondary sympatry takes a long time to occur. Instead, it seems that the
temporal dynamics of diversification in some species of \textit{Holothuria
  impatiens} is similar to what is observed for species occurring in continental
settings.

What do species of the \textit{H. impatiens} do differently that all allow them
to colonize the range of closely related species? More specifically, what does
allow ESU1 to behave like a species of a continental setting?  In the case of
closely related but reproductively isolated lineages, the strict allopatry
observed suggests that species fail to establish themselves in another species'
range. In most cases, dispersal limitation alone is insufficient to explain this
pattern. Enough individuals need to colonize to overcome Allee effects, and
resource partitioning or availability need to be sufficient to allow species
coexistence \cite{Meyer2005}. Along coastlines, the number of individuals from
incipient species interacting is much higher than in oceanic setting allowing
reproductive isolation to complete more rapidly. These interactions manifest for
resource competition leading to strong divergent selection for resource
partitioning, in turn these selective pressures speed up the speciation process
through reinforcement. Additionally, in sea urchins, high population densities
lead to conditions that favor divergent selection in gamete recognition proteins
(GRP), a mechanism that would allow reproductive isolation to evolve rapidly
\cite{Levitan2006a}. Even if \textit{H. impatiens} produce lots of long-lived
...
allow for (1) rapid reproductive isolation; (2) recent range expansion leading to
secondary sympatry for ESU1.
...
% Factors contributing to small populations sizes:
% - variation in reproductive success
% - local populations going extinct because of sea level fluctuations
...
% typically oceanic islands remain with 1 species/takes a long time for
% secondary sympatry
% - mechanisms that allow that?
% - tie also that rapid secondary sympatry is associated with continental
% margins


Peripheral speciation has been 
