...
recent range expansion of ESU1. We favor this hypothesis as the genetic
diversity of ESU1 is low (61 individuals sequenced, 18 haplotypes, the 3 most
common haplotypes found in 40 individuals). The pattern of a widespread species
being a terminal branch in a clade suggests that this species was the source of
peripheral species \cite{Malay2010,Bowen2013}. Additionally, isolated areas
...
Differentiation along ecological gradients has nonetheless played a role in the
diversification of this complex. For instance, tiger is only found in the
...
and Tanzania but was not found in the oligotrophic islands of Mayotte or the
Scattered islands sampled. It is however found in Palau and the Ryukyus but the
former is known to be characterized with extensive eutrophic lagoons, and the
latter is under the influence of upwellings.
% *TODO* check these claims.
