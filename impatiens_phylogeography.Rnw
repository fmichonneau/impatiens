...
\begin{tabular}{ l l p{6cm} l l l}
  ...
  \hline
  % COI --- 
  COI &  COIceF  & ACT GCC CAC GCC CTA GTA ATG ATA TTT TTT ATG GTN ATG CC & 42 & 40 & \multirow{2}{*}{\cite{Hoareau2010}} \\
       & COIceR  & TCG TGT GTC TAC GTC CAT TCC TAC TGT RAA CAT RTG & & & \\
  % 16S ---
  16S & 16SAR & CGC CTG TTT ATC AAA AAC AT & 52 & 35 & \multirow{2}{*}{\cite{Arndt1996}} \\
      & 16SBR & GCC GGT CTG AAC TCA GAT CAC GT & & & \\
  % 16Sc ---
  %% TODO 
  % ATP6 ---
  ATP6 & ATP6f   & GGA CAA TTT TCC CCA GAC CT & 42 & 40 & \multirow{2}{*}{This study} \\
       & ATP6r   & GGT GAA GAG GGT GTT GAT GG & & & \\
  % 28S ---
  28S  & LSUFW1  & AGC GGA GGA AAA GAA ACT A &  42 & 40 & \multirow{2}{*}{\cite{Sonnenberg2007}} \\
       & LSUREV2 & ACG ATC GAT TTG CAC GTC AG & & & \\
  % ITS ---
  ITS1-5.8S-ITS2 & fm-ITS-f  & AGG TGA ACC TGC AGA TGG ATC A & 45 & 40 & \multirow{2}{*}{This study, \cite{Lacey2005,Sonnenberg2007}} \\
                  & fm-5.8S-f & CGT CGA TGA AGA ACG CAG YW & & & \\
                  & fm-ITS-r  & TAG TTT CTT TTC CTC CGC T  & & & \\
  % c0036 ---
  c0036 & c0036f & TAA CGA CGG ATC TCA CGG AG & 42 & 45 & \multirow{2}{*}{This study} \\
        & c0036r & AAT AAT GCT GGC GTG ACG TC & & & \\
  % c0775 ---
  c0775 & c0775f & GCT CTT CGT TCA ATT TAT CTC GC & 42 & 40 & \multirow{2}{*}{This study} \\
...
migration rates on GMYC accuracy and precision \cite{Papadopoulou2008,
  Esseltyn2012}. Some of the effects of the methodological choices have been
...
\cite{Marshall2011a, Esseltyn2012}).
...
\cite{Paulay1994}, marine snails \cite{Abbott1960, Reid2006, Williams2011},
...
vertebrates (e.g., \cite{Taylor2005,Rocha2013}), and invertebrates (e.g.,
\cite{Meyer2005,Malay2010,Williams2011}). As a result, closely related species
show strict allopatric distribution in oceanic setting (e.g., as in
\cite{Meyer2005}) but occur in sympatry along continental margins (e.g.,
...
reproductive isolation to evolve rapidly \cite{Levitan2006a}.
...
\cite{Gonzales2008a}. Additionally, echinoderms are renown to experience drastic
...
\cite{Meyer2005}.  Even if \textit{H. impatiens} produce lots of long-lived
