...
In the case of closely related but reproductively isolated lineages, the strict
allopatry observed suggests that species fail to establish themselves in another
species' range. In most cases, dispersal limitation alone is insufficient to
explain this pattern. Enough individuals need to colonize to overcome Allee
effects, and resource partitioning or availability need to be sufficient to
allow species coexistence \cite{Meyer2005}. What do species of the
\textit{H. impatiens} do differently that all allow them to colonize the range
of closely related species? More specifically, what does allow ESU1 to behave
like a species of a continental setting? One hypothesis to explain the
difference between oceanic and continental taxa is related to their
demographic. Along coastlines, the number of individuals from incipient species
interacting is much higher. These interactions manifest for resource competition
leading to strong divergent selection for resource partitioning, in turn these
selective pressures speed up the speciation process through
reinforcement. Additionally, in sea urchins, high population densities lead to
conditions that favor divergent selection in gamete recognition proteins (GRP),
a mechanism that would allow reproductive isolation to evolve rapidly
\cite{Levitan2006a}.
