...
opts_chunk$set(fig.path='figures/latex-', cache.path='cache/latex-',
...
<<impatiens-tree, eval=TRUE, cache=TRUE, echo=FALSE, fig.keep='last', fig.height=12, fig.cap='full phylogenetic of the impatiens complex'>>=
@
