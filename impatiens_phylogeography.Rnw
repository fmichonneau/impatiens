...
approaches by \cite{Leache2010,Grummer2014,Satler2013}. First, we used the
...
\caption{Correspondence between the different criteria used to delineate the species.}
\end{figure}
...
\begin{table}[h]
  ...
  \caption{The subscript number corresponds to the to the codon position in the
    ...
    (i.e., COI$_1$ is 3rd codon position)}
  \begin{tabular} { l l l }
