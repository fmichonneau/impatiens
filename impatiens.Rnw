...
% Words are cut where needed %% syst-bio uses Babel
...
The discovery methods, based on genetic differentiation in COI, delineated at
least 13 putative species. Ten of these were supported by morphological (color)
or broad geographical evidence, while three were not so distinguishable.
Testing methods supported the remaining three as genetically-isolated, cryptic
species, corroborating the existence of 13 species.

The consideration of geography and differences in color patterns allowed the
recognition of 10 species in the complex in retrospect
